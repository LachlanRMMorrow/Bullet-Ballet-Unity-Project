...
public class AI : MonoBehaviour {
	...
	protected bool canSeePlayer() {
		RaycastHit hit;
		//get the layer of the Bullets, which is 9
		//convert to a bitmask (000100000000)
		//then flip it, because the raycast will only look for objects where there is 1 in their mask slot
		//111011111111
		int layerMask = ~(1 << LayerMask.NameToLayer("Bullets") | 1 << LayerMask.NameToLayer("RoomFog") | 1 << LayerMask.NameToLayer("Enemies"));
