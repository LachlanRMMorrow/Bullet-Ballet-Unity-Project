...
Shader "Shader Forge/Examples/Refraction" {
    Properties {
        ...
        _node_1888 ("node_1888", Color) = (0.6911765,0,0,1)
...
////// Specular:
                ...
                float node_5383 = 3.0;
                float3 diffuseColor = (_node_1888.rgb*node_5383); // Need this for specular when using metallic
...
/// Final Color:
                ...
                return fixed4(lerp(sceneColor.rgb, finalColor,0.05),1);
            }
            ENDCG
        }
        Pass {
...
/// Final Color:
                float3 finalColor = diffuse + specular;
                return fixed4(finalColor * 0.05,0);
            }
            ENDCG
        }
        Pass {
